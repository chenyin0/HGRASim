...
//				regfile.width(15);
		...
		Debug():print_screen_begin(0), print_screen_end(200), print_flow_begin(0), print_flow_end(500000),print_screen_interval(1),
			print_file_begin(0), print_file_end(200), print_file_interval(1) {
